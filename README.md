...
* 📌 **Mes projets publics** académique ou personnels
* 📚 **Mes supports de cours** et **exercices**.
* 🛠️ **Des outils pédagogiques** , templates, exercices guidés et ressources open source

---
## 🎓 Etudiante en L1 de Génie Logiciel à ISI (Institut Supérieur d'Informatique)
...
| Cours | Niveau | Description |
|-------|--------|-------------|
| [HTML & CSS](https://github.com/Robsroberto/Cours_HTML_CSS) | L1 | HTML5, CSS3, Flexbox, Grid, Responsive design |
